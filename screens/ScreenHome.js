...
import { Input, Center, NativeBaseProvider, FormControl, extendTheme, HStack, Link, Icon, Box, FlatList, VStack, Spacer, Avatar } from "native-base";
            ...
            <NativeBaseProvider theme={theme}>
                ...
                <Center flex={1}>
                    ...
                    <FlatList data={data} renderItem={({
                        item
                    }) => <Box borderBottomWidth="0.5" _dark={{
                        borderColor: "muted.50"
                    }} borderColor="muted.800"  py="2">
                            <Pressable onPress={() => {
                                if(user=="admin"){
                                    alert(item.id)
                                }
                                ...
                                <HStack space={[8, 2]} justifyContent="space-between">
